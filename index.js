...
function sortByPricingAsc(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}
function sortByPricingDesc(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing == 'low-to-high') {
    result.sort(sortByPricingAsc);
  } else {
    result.sort(sortByPricingDesc);
  }
  res.json({ hotels: result });
});

function sortByRatingAsc(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}
function sortByRatingDesc(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating == 'low-to-high') {
    result.sort(sortByRatingAsc);
  } else {
    result.sort(sortByRatingDesc);
  }
  res.json({ hotels: result });
});

function sortByReviewsAsc(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}
function sortByReviewsDesc(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews == 'least-to-most') {
    result.sort(sortByReviewsAsc);
  } else {
    result.sort(sortByReviewsDesc);
  }
  res.json({ hotels: result });
});
